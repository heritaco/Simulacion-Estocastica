...
\(X\sim\mathrm{Unif}(a,b)\), entonces su función de distribución
acumulada es:
...
\end{tcolorbox}
    ...
    \hypertarget{b-grafica-de-f_xx}{%
\subsection{\texorpdfstring{b) 
\(F_X(x)\)}{b) F\_X(x)}}\label{b-grafica-de-f_xx}}
...
\end{tcolorbox}
    ...
    \hypertarget{c-grafica-de-f-1_xu}{%
\subsection{\texorpdfstring{c) 
\(F^{-1}_X(u)\)}{c) F\^{}\{-1\}\_X(u)}}\label{c-grafica-de-f-1_xu}}
...
\section{8. Mixta Mínimo}}\label{mixta-xminym-con-ysimmathrmexplambda}}
...
\end{tcolorbox}
    ...
    \hypertarget{b-grafica-de-f-1_xu}{%
\subsection{\texorpdfstring{b) 
\(F^{-1}_X(u)\)}{b) F\^{}\{-1\}\_X(u)}}\label{b-grafica-de-f-1_xu}}
...
\section{10. Por Tramos}\label{variable-con-cdf-por-tramos}}
    ...
    \hypertarget{a-grafica-de-f_xx}{%
\subsection{\texorpdfstring{a) 
\(F_{X}(x)\)}{a) F\_\{X\}(x)}}\label{a-grafica-de-f_xx}}
...
\dfrac12,& -1\leq x<1,\\[6pt]
\dfrac{x}{2},& 1\leq x<2,\\[6pt]
1,& x\geq 2.
\end{cases}
\]
...
\subsection{b) Geométrica}\label{b-geometrica}}
