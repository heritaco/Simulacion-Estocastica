...
\(F_X(x)\)}{b) Grafica de F\_X(x)}}\label{b-grafica-de-f_xx}}
...
\subsection{\texorpdfstring{c) Grafica de
\(F^{-1}_X(u)\)}{c) Grafica de F\^{}\{-1\}\_X(u)}}\label{c-grafica-de-f-1_xu}}
...
\subsection{\texorpdfstring{b) Grafica de
\(F^{-1}_X(u)\)}{b) Grafica de F\^{}\{-1\}\_X(u)}}\label{b-grafica-de-f-1_xu}}
...
tramos}\label{variable-con-cdf-por-tramos}}
    ...
    \hypertarget{a-grafica-de-f_xx}{%
\subsection{\texorpdfstring{a) Grafica de
\(F_{X}(x)\)}{a) Grafica de F\_\{X\}(x)}}\label{a-grafica-de-f_xx}}
